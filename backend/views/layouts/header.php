        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="/images/keylor_navas.png" alt="User Avatar" class="img-size-50 img-circle mr-3">
        ...
        <li class="nav-item dropdown user-menu">
            ...
            <ul class="dropdown-menu dropdown-menu-xl dropdown-menu-right">
                ...
                <li class="user-header bg-primary">
                    ...
                    <p>
                        <?php echo z()->user->identity['username'] . " - " . (!empty($roles = z()->authManager->getRolesByUser(z()->user->identity['id'])) ? array_keys($roles)[0] ?? 'None' : 'No Roles')?>
                        <small><?php echo t('backend', 'Member since ' . date('d-m-Y', strtotime(z()->user->identity['created_at']))) ?></small>
                    </p>
                </li>
                <!-- Menu Body -->
                <li class="user-body">
